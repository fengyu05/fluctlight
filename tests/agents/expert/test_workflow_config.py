...
class TestWorkflowConfig(unittest.TestCase):
    ...
    def setUp(self):
        self.config_dict = {
            ...
            "input_schema": {
                "input1": "tests.agents.expert.test_workflow_config.SomeEntityA",
                "input2": "str"
            },
            "output_schema": "tests.agents.expert.test_workflow_config.SomeEntityB",
            "success_criteria": "Test criteria"
        }

    @patch('fluctlight.agents.expert.workflow_config.WorkflowNodeConfig._import_type')
