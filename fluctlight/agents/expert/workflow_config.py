...
ContextValue = None | str | float | WorkflowSchemaType | list[WorkflowSchemaType] | dict[str, WorkflowSchemaType]
...
class WorkflowNodeConfig(BaseModel):
    ...
    @classmethod
    def _load_input_schema(cls, input_schema: Dict[str, str]) -> Dict[str, Type[WorkflowSchemaType]]:
...
def is_internal_upstream(upstream: str) -> bool:
    ...
    return upstream in [INTERNAL_UPSTREAM_INPUT_MESSAGE, INTERNAL_UPSTREAM_HISTORY_MESSAGES]